...
const Footer = () => {
  return (
    <footer className="bg-[#131118] text-white py-16">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-4 gap-8">
          {/* Logo and Contact Info */}
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">Krist</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/delivery" className="hover:text-gray-300">Delivery Information</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/cart" className="hover:text-gray-300">My Cart</a></li>
              <li><a href="/wishlist" className="hover:text-gray-300">My Wishlist</a></li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="bg-transparent border border-white/20 rounded px-4 py-2 flex-grow"
              />
