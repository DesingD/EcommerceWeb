...
const Footer = () => {
  return (
    <footer className="bg-[#131118] text-[#D8D7D8] pt-16 pb-5">
      <div className="max-w-7xl mx-auto px-12">
        <div className="grid grid-cols-3 gap-8">
          {/* Logo and Contact Info */}
          <div className="space-y-4">
            <h2 className="text-6xl font-medium text-white">Krist</h2>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 grid grid-cols-3 gap-8">
          ...
          <p className="text-center">©2023 Krist All Rights are reserved</p>
